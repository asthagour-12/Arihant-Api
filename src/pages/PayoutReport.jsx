        ...
        <div className="bg-gray-50/50 p-6 rounded-2xl border border-gray-100 shadow-sm space-y-4">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto h-[48px]">
              <button
                onClick={handleClear}
                className="w-[130px] h-[48px] bg-rose-50 text-rose-600 border border-rose-100 rounded-xl font-bold text-[13px] flex items-center justify-center gap-2 hover:bg-rose-500 hover:text-white transition-all active:scale-95"
              >
                <XCircle size={15} />
                CLEAR
              </button>
              <button
                ...
                className="w-[130px] h-[48px] bg-[#27ae60] text-white rounded-xl font-bold text-[13px] flex items-center justify-center gap-2 hover:bg-[#219150] shadow-lg shadow-[#27ae60]/20 transition-all active:scale-95"
              >
                <Search size={15} />
                SEARCH
              </button>
